...
function genderator_code(value, position) {
    ...
    $('#code_genderator_start .card').each(function(i){
        ...
        html = html.replace('{{title1_mids_'+(i+1)+'}}', $(this).find('#input_title1_mids'+(i+1)).val());
        html = html.replace('{{descrition_mids_'+(i+1)+'}}', $(this).find('#input_descrition_mids'+(i+1)).val());
        html = html.replace('{{text1_mids_'+(i+1)+'}}', $(this).find('#input_text1_mids'+(i+1)).val());
        html = html.replace('{{text2_mids_'+(i+1)+'}}', $(this).find('#input_text2_mids'+(i+1)).val());
        html = html.replace('{{text3_mids_'+(i+1)+'}}', $(this).find('#input_text3_mids'+(i+1)).val());
        html = html.replace('{{text4_mids_'+(i+1)+'}}', $(this).find('#input_text4_mids'+(i+1)).val());
        html = html.replace('{{text5_mids_'+(i+1)+'}}', $(this).find('#input_text5_mids'+(i+1)).val());
